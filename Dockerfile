...
#&& /usr/local/bin/yolo settings datasets_dir="/data/datasets"
RUN mkdir /data/weights 
#&& /usr/local/bin/yolo settings weights_dir="/data/weights"
RUN mkdir /data/runs 
#&& /usr/local/bin/yolo settings runs_dir="/data/runs"
